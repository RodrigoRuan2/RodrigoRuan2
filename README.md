...
**Desenvolvedor Front-End em formação** · React · TypeScript · Python · ADS @ UDF
...
Plataforma full-stack de e-commerce com curadoria premium. Desenvolvida com **React + Vite** no frontend e **Express + Supabase** no backend.
...
`React` `Vite` `Express` `Supabase` `Node.js` `PostgreSQL` `React Router`
...
[![Email](https://img.shields.io/badge/Email-ruancamisaazul@gmail.com-D14836?style=flat-square&logo=gmail&logoColor=white)](mailto:ruancamisaazul@gmail.com)
